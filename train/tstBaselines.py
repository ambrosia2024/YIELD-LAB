...
--------------------
Author: XYZ
Description: A time series transformers based framework crop yield prediction that combines state-of-the-art time architectures with agricultural domain knowledge. 
...
# %% Global constants
# NOTE: KEY_LOC, KEY_YEAR, KEY_TARGET, KEY_DATES, KEY_CROP_SEASON, and CROP_CALENDAR_DATES are imported from cybench.config
